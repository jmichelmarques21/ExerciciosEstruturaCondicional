    ...
    class Program {
        static void Main(string[] args) {
            ...
            */
            ...
            /* Exercício 06 - Você deve fazer um programa que leia um valor qualquer e apresente uma mensagem dizendo em qual dos seguintes intervalos ([0,25], [25,50], [50,75], [75,100]) este valor se encontra. Obviamente se o valor não estiver em nenhum desses intervalos, deverá ser impressa a mensagem "Fora de intervalo".
            ...
            */
            ...
            // Exercício 07 - Leia 2 valores com uma casa decimal (x e y), que devem representar as coordenadas de um ponto em um plano. A seguir, determine o quadrante ao qual pertence o ponto, ou se está sobre um dos eixos cartesianos ou na origem (x = y = 0). Se o ponto estiver na origim, escreva a mensagem "Origem". Se o ponto estiver sobre um dos eixos escreva "Eixo X" ou "Eixo Y", conforme for a situação. (Quadrantes de Q1 a Q4 seguindo ordem anti-horária).
